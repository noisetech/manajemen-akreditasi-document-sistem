    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                ...
                <p class="text-subtitle text-muted">List Kategori Berita</p>
            </div>
    ...
    <div class="card shadow">
        <div class="card-header">
            <div class="d-flex justify-content-end">
                <a href="{{ route('kategori_berita.tambah') }}" class="badge bg-primary tambah text-white">
                    Tambah
                </a>
            </div>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered text-center" style="width: 100%;" id="datatable">
                    ...
                    <tbody>
                        @forelse ($kategori_berita as $f)
                        <tr>
                            <td class="text-start">{{ $f->kategori }}</td>
