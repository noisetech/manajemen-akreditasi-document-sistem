    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Akreditasi</h3>
                <p class="text-subtitle text-muted">Edit Akreditasi</p>
            </div>
        ...
        <div class="card-body">
            <form action="{{ route('arsip-akreditasi.simpan') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="sumber_data" class="form-control" value="{{ $arsip_akreditasi->sumber_data }}">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="jenis" class="form-control" value="{{ $arsip_akreditasi->jenis  }}">
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="no_urutan" class="form-control" value="{{ $arsip_akreditasi->no_urutan }}">
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="no_butir" class="form-control" value="{{ $arsip_akreditasi->no_butir }}">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="bobot" class="form-control" value="{{ $arsip_akreditasi->bobot }}">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="elemen_penilaian_lam" class="form-control" value="{{ $arsip_akreditasi->elemen_penilaian_lam }}">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="deskripsi" class="form-control deskriptor">{!! $arsip_akreditasi->deskripsi !!}</textarea>
                </div>

                <div class="form-group">
                    <label for="">Penilaian:</label>
                    <textarea name="penilaian" id="" class="form-control nilai">{!! $arsip_akreditasi->penilaian !!}</textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    @if($arsip_akreditasi->file_pendukung)
                    <small class="text-muted">Current file: {{ basename($arsip_akreditasi->file_pendukung) }}</small>
                    @endif
                </div>
